actor_a1 = {blood = 100,speed = 50,damage = 10,money = 10,range =5}
actor_a2 = {blood = 200,speed = 50 ,damage = 30 ,money = 20,range =100}
actor_a3 = {blood = 200,speed = 100 ,damage = 40 ,money = 20,range =5}
actor_a4 = {blood = 200,speed = 50 ,damage = 20 ,money = 20,range =5}
actor_b1 = {blood = 100,speed = 50,damage = 10,money = 10,range =5}
actor_b2 = {blood = 200,speed = 50 ,damage = 30 ,money = 20,range =100}
actor_b3 = {blood = 200,speed = 100 ,damage = 40 ,money = 20,range =5}
